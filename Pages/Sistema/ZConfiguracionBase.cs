...
{
	public class ZConfiguracionBase : ComponentBase 
	{
        public const string TBita = "Variables Configuracion";
        ...
        public RadzenDataGrid<ZConfig>? ZconfigGrid { get; set; } = new RadzenDataGrid<ZConfig>();
        ...
        protected override async Task OnInitializedAsync()
        {
            if (Primera)
            {
                ...
                if (!LosConfigs.Any()) await LeerLosConf();
            }
